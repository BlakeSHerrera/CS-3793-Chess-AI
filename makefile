...
SRCS = main.c bitboard.c move.c movegen.c piece.c position.c square.c Release/uci.c Release/magic.c Release/debug.c
...
obj/main.o: main.c bitboard.h debug.h move.h movegen.h piece.h position.h square.h uci.h magic.h
	$(CC) $(CFLAGS) -c $< -o $@
